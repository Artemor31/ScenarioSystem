...
namespace Assets.SimpleLocalization
{
    ...
    public static class LocalizationManager
    {
        ...
        public static string Localize(string localizationKey)
        {
            ...
            {
                if (!Dictionary["English"].ContainsKey(localizationKey)) return null;
                // throw new KeyNotFoundException("Translation not found including in English: " + localizationKey);
                else return Dictionary["English"][localizationKey];
            }
            else if(Dictionary[Language][localizationKey] == "" || Dictionary[Language][localizationKey] == " " || Dictionary[Language][localizationKey] == null)
            {
                if (Dictionary["English"][localizationKey] != "" && Dictionary["English"][localizationKey] != " " && Dictionary["English"][localizationKey] != null)
                {
        ...
        public static string Localize(string localizationKey, string lang)
        {
            if (Dictionary.Count == 0)
            {
                Read();
            ...
            if (!Dictionary.ContainsKey(lang)) throw new KeyNotFoundException("Language not found: " + lang);
            if (!Dictionary[lang].ContainsKey(localizationKey))
            {
        ...
        public static string Localize(string localizationKey, string lang, params object[] args)
        {
            var pattern = Localize(localizationKey, lang);
